...
def test_should_not_do_filter_pruning_on_expression_string_filters(
    ...
    with DuckDBUnittestRunner(
        ...
        runner.run_sqllogic_file(
            Path(__file__).with_name("should_not_do_filter_pruning_on_expression_string_filters.test")
        )
