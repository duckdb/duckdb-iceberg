...
//! DuckDB's FileSystem, so object stores (S3/Azure/GCS) keep working -- unlike avro-c's codec writer,
//! which only targets local paths. No external/cross-repo changes are required.
