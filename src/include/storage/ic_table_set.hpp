...
public:
	...
	optional_ptr<CatalogEntry> AddEntry(unique_ptr<CatalogEntry> entry) override;
...
private:
	unique_ptr<CatalogEntry> CreateTableEntry(Catalog &catalog, SchemaCatalogEntry &schema, ICAPITable table);
};
