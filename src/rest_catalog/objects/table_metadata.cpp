...
string TableMetadata::TryFromJSON(yyjson_val *obj) {
	...
	if (location_val && !yyjson_is_null(location)) {
		has_location = true;
	...
	if (last_updated_ms_val && !yyjson_is_null(last_updated_ms)) {
	...
	if (next_row_id_val && !yyjson_is_null(next_row_id)) {
	...
	if (properties_val && !yyjson_is_null(properties)) {
		has_properties = true;
	...
	if (schemas_val && !yyjson_is_null(schemas)) {
		has_schemas = true;
	...
	if (current_schema_id_val && !yyjson_is_null(current_schema_id)) {
	...
	if (last_column_id_val && !yyjson_is_null(last_column_id)) {
	...
	if (partition_specs_val && !yyjson_is_null(partition_specs)) {
	...
	if (default_spec_id_val && !yyjson_is_null(default_spec_id)) {
	...
	if (last_partition_id_val && !yyjson_is_null(last_partition_id)) {
	...
	if (sort_orders_val && !yyjson_is_null(sort_orders)) {
	...
	if (default_sort_order_id_val && !yyjson_is_null(default_sort_order_id)) {
	...
	if (encryption_keys_val && !yyjson_is_null(encryption_keys)) {
	...
	if (snapshots_val && !yyjson_is_null(snapshots)) {
		has_snapshots = true;
	...
	if (refs_val && !yyjson_is_null(refs)) {
		has_refs = true;
	...
	if (last_sequence_number_val && !yyjson_is_null(last_sequence_number)) {
	...
	if (snapshot_log_val && !yyjson_is_null(snapshot_log)) {
	...
	if (metadata_log_val && !yyjson_is_null(metadata_log)) {
	...
	if (statistics_val && !yyjson_is_null(statistics)) {
		has_statistics = true;
	...
	if (partition_statistics_val && !yyjson_is_null(partition_statistics)) {
