...
string DataFile::TryFromJSON(yyjson_val *obj) {
	...
	if (first_row_id_val && !yyjson_is_null(first_row_id)) {
	...
	if (column_sizes_val && !yyjson_is_null(column_sizes)) {
	...
	if (value_counts_val && !yyjson_is_null(value_counts)) {
	...
	if (null_value_counts_val && !yyjson_is_null(null_value_counts)) {
	...
	if (nan_value_counts_val && !yyjson_is_null(nan_value_counts)) {
	...
	if (lower_bounds_val && !yyjson_is_null(lower_bounds)) {
	...
	if (upper_bounds_val && !yyjson_is_null(upper_bounds)) {
